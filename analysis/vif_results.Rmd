...
ggsave(filename = "../figures/FractionOfVirusMapped_vs_ReadsMapped.pdf", width = 5, height = 5)
...
ggsave(filename = "../figures/FractionOfVirusMapped_vs_CPM.pdf", width = 5, height = 5)
...
ggsave(filename = "../figures/VirusesPerSpecimen.pdf", width = 5, height = 8)
```
